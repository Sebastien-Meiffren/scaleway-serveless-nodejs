...
const functionGateway = async (req: express.Request, res: express.Response) => {
    ...
    if (!handler) {
        ...
        const handlerName = req.query.handlerName; // body NOT query in the scaleway script
        const handlerFilePath = req.query.handlerPath; // body NOT query in the scaleway script
        try {
